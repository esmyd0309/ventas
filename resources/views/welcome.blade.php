                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            ...
                            <a class="navbar-brand" href="{{ route('archivos')  }}"> <img src="http://192.168.1.107/ventas/public/img/moto.png" width="100" height="100" class="rounded-pill" title=""></a><p>TERRENO</p>
                        </div>
