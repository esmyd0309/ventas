...
use App\DAMPLUSreportesCobranza;
use App\Campana;
...
class DAMPLUSreportesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $SAC_NVO=DAMPLUSreportesCobranza::where('pagos','<>','0')->where('area','SAC_NVO')->get();
        $VENCIDO=DAMPLUSreportesCobranza::where('area','CARTERA_NUEVA_2018')->get();
        $CARTERA_NUEVA_2018=DAMPLUSreportesCobranza::where('area','VENCIDO_ISAAC')->get();
  
      //dd($CARTERA_NUEVA_2018);
     // return response()->json($SAC_NVO, 200);
        return view('reportes.cobranza.index', compact('SAC_NVO','VENCIDO','CARTERA_NUEVA_2018'));
    }
